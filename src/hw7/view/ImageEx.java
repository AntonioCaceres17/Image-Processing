...
public class ImageEx extends JFrame implements ActionListener, ItemListener, ListSelectionListener {
  ...
  public void actionPerformed(ActionEvent arg0) {
    ...
    switch (arg0.getActionCommand()) {
      ...
      case "Size options":
        ...
        break;
      case "Color chooser":
        Color col = JColorChooser.showDialog(ImageEx.this, "Choose a color", colorChooserDisplay.getBackground());
      ...
      case "Open file": {
        ...
        int retvalue = fchooser.showOpenDialog(ImageEx.this);
      ...
      case "Save file": {
        final JFileChooser fchooser = new JFileChooser(".");
        int retvalue = fchooser.showSaveDialog(ImageEx.this);
        if (retvalue == JFileChooser.APPROVE_OPTION) {
          File f = fchooser.getSelectedFile();
      ...
      break;
      case "Message":
        JOptionPane.showMessageDialog(ImageEx.this, "This is a demo message", "Message", JOptionPane.PLAIN_MESSAGE);
        JOptionPane.showMessageDialog(ImageEx.this, "You are about to be deleted.", "Last Chance", JOptionPane.WARNING_MESSAGE);
        JOptionPane.showMessageDialog(ImageEx.this, "You have been deleted.", "Too late", JOptionPane.ERROR_MESSAGE);
        JOptionPane.showMessageDialog(ImageEx.this, "Please start again.", "What to do next", JOptionPane.INFORMATION_MESSAGE);
        break;
      case "Input":
      ...
      case "Option": {
        ...
        int retvalue = JOptionPane.showOptionDialog(ImageEx.this, "Please choose number", "Options", JOptionPane.YES_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[4]);
  ...
  public void valueChanged(ListSelectionEvent e) {
    ...
    JOptionPane.showMessageDialog(ImageEx.this,
